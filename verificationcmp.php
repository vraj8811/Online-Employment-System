...
<body>
    ...
    <div class="container border-secondary p-5 center-block">
        <form method="post" action="verificationcmp.php">
            <div class="card text-center">
                ...
                <div class="card-body">
                    ...
                    <p class="card-text">
                        <b>Sent to</b><?php session_start(); echo $_SESSION['cmpemail'] ?>
                    </p>
                    <input type="text" pattern="\d*" maxlength="6" minlength="6" name="cmpcode" placeholder="6 Digit Code" />
                    <br />
                    <br />
...
if($_SERVER['REQUEST_METHOD'] == "POST") {
    if(isset($_SESSION['secretcode'])) {
        ...
        $cmpsqlreg = $_SESSION['insertcmpreg'];
        $cmpenteredcode = $_POST['cmpcode'];
        if($sesscode != $cmpenteredcode) {
            ...
            try {
                ...
                if(mysqli_query($conn,$cmpsqlreg)) {
